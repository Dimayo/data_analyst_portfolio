...
[Код проекта в jupyter notebook]([car_subscription/subscription_data.ipynb](https://github.com/Dimayo/data_analyst_portfolio/blob/main/car_subscription/subscription_data.ipynb)) <br>
