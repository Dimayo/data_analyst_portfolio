...
Публичные учебные разборы по продуктовой аналитике и BI. В каждом кейсе — краткое резюме: задача, результат и вывод. Подробный расчёт — в ноутбуке или на дашборде. Исходные данные не выкладываю. Коммерческий опыт (DWH, Airflow, DataLens, API) — в [профиле](https://github.com/dimayo).

| Проект | Результат | Стек |
|---|---|---|
| [Продажи маркетплейса](marketplace_sales) | Дашборд DataLens: продажи **5,62 млрд** ₽; план выполнен; электроника лидирует по выручке | Yandex DataLens |
